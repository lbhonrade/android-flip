...
public class FlipCards {
	...
	public synchronized boolean handleTouchEvent(MotionEvent event,
		...
		case MotionEvent.ACTION_DOWN:
			...
			float coord = orientationVertical ? event.getYPrecision()
					* event.getY() : event.getXPrecision() * event.getX();
			float maxTouch = orientationVertical ? controller
					.getContentHeight() : controller.getContentWidth();
